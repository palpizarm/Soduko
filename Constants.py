...
BTSAVE_X = GAME_WEIGTH*0.45 + 120
BTSAVE_Y = BUTTON_Y + 100

BTLOAD_X = GAME_WEIGTH*0.45
BTLOAD_Y = BUTTON_Y + 100


BTSOLVE_X = GAME_WEIGTH*0.5 + 205
BTSOLVE_Y = BUTTON_Y + 100

OPTION_X = GAME_WEIGTH*0.8
OPTION_Y = CONTAINER_Y

SELECTED_X = GAME_WEIGTH*0.8 - 80
...
FILL_OPTION1 = [MATRIX_NUMBERS,["white"]*9]
FILL_OPTION2 = [MATRIX_LETTERS,["white"]*9]
FILL_OPTION3 = [[""]*9,MATRIX_COLORES]
FILL_OPTION4 = [[""]*9,["white"]*9]
